...
/**
 * process_file - executes file handling functions
 * @filename: pointer to file name string
 * Returns: map_t data structure containing map information
 */
...
/**
 * start_file - initiates opening of a file
 * @filename: pointer to file name string
 * Return: File pointer
 */
...
/**
 * fetch_file - retrieves the contents of a file
 * @fp: File pointer
 * Returns: map_t data structure with map data
 */
